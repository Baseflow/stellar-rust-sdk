...
pub mod test {
    ...
    async fn test_get_all_payments() {
        ...
        let response: Result<PaymentsResponse, String> = horizon_client.get_all_payments(&all_payments_request).await;
    ...
    async fn test_get_payments_for_account() {
        ...
        let payments_for_account_request: PaymentsForAccountRequest = PaymentsForAccountRequest::new().set_account_id("GBRPYHIL2CI3FNQ4BXLFMNDLFJUNPU2HY3ZMFSHONUCEOASW7QC7OX2H".to_string());

        let response: Result<PaymentsResponse, String> = horizon_client.get_payments_for_account(&payments_for_account_request).await;
