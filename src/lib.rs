...
// #[macro_export]
// macro_rules! impl_paginatable {
//     ($struct_name:ident) => {
//         impl Paginatable for $struct_name {
//             fn set_cursor(&mut self, cursor: Option<u32>) -> Result<(), String> {
//                 if cursor == Some(0) {
//                     Err("Cursor cannot be zero.".to_string())
//                 } else {
//                     self.cursor = cursor;
//                     Ok(())
//                 }
...
//             fn set_limit(&mut self, limit: Option<u8>) -> Result<(), String> {
//                 if limit > Some(200) || limit == Some(0) {
...
//             fn set_order(&mut self, order: Option<Order>) -> Result<(), String> {
//                 // Assuming you always accept the order, but you could add logic here
//                 self.order = order;
//                 Ok(())
//             }
//         }
